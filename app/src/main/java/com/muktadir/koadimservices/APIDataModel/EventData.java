...
public class EventData {
        ...
        public EventData(int id, String name, String slug, String home_image_url, boolean is_last_node, List<OptionsArray>options, ImageThumb image_thumb_url, IconThumb icon_thumb_url, List<ServiceTypeInner> service_types) {
            this.id = id;
            this.name = name;
            this.slug = slug;
